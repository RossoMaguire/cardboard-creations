...
export enum AssemblyVideoIdType {
...
/** Arguments for filtering the UserToAssemblyVideoConnection connection */
export interface UserToAssemblyVideoConnectionWhereArgs {
...
export interface MediaItemToCategoryConnectionWhereArgs {
...
export interface CategoryToMediaItemConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: Maybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: Maybe<Array<Maybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the UserToStaffMemberConnection connection */
export interface UserToStaffMemberConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: Maybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: Maybe<Array<Maybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the RootQueryToAssemblyVideoConnection connection */
export interface RootQueryToAssemblyVideoConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: Maybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: Maybe<Array<Maybe<Scalars["ID"]>>>;
...
/** Arguments for filtering the EmployeeToEmployeeConnection connection */
export interface EmployeeToEmployeeConnectionWhereArgs {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: Maybe<Scalars["String"]>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: Maybe<Scalars["Int"]>;
...
export interface RootQueryToStaffMemberConnectionWhereArgs {
  /** The user that's connected as the author of the object. Use the userId for the author object. */
  author?: Maybe<Scalars["Int"]>;
  /** Find objects connected to author(s) in the array of author's userIds */
  authorIn?: Maybe<Array<Maybe<Scalars["ID"]>>>;
...
/** Input for the createAssemblyVideo mutation */
export interface CreateAssemblyVideoInput {
...
export interface CreateEmployeeInput {
  /** The slug that the employee will be an alias of */
  aliasOf?: Maybe<Scalars["String"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars["String"]>;
  /** The description of the employee object */
  description?: Maybe<Scalars["String"]>;
  /** The name of the employee object to mutate */
  name: Scalars["String"];
  /** The ID of the employee that should be set as the parent */
  parentId?: Maybe<Scalars["ID"]>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug?: Maybe<Scalars["String"]>;
}
...
/** Input for the deleteAssemblyVideo mutation */
export interface DeleteAssemblyVideoInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: Maybe<Scalars["Boolean"]>;
  /** The ID of the assemblyVideo to delete */
  id: Scalars["ID"];
}
...
export interface DeleteStaffMemberInput {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars["String"]>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: Maybe<Scalars["Boolean"]>;
...
/** Input for the updateAssemblyVideo mutation */
export interface UpdateAssemblyVideoInput {
  /** The userId to assign as the author of the object */
  authorId?: Maybe<Scalars["ID"]>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars["String"]>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: Maybe<Scalars["String"]>;
  /** The ID of the assemblyVideo object */
  id: Scalars["ID"];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: Maybe<Scalars["Int"]>;
  /** The password used to protect the content of the object */
...
export interface UpdateEmployeeInput {
  ...
  /** The description of the employee object */
  description?: Maybe<Scalars["String"]>;
  /** The ID of the employee object to update */
  id: Scalars["ID"];
  /** The name of the employee object to mutate */
  name?: Maybe<Scalars["String"]>;
  /** The ID of the employee that should be set as the parent */
...
export interface UpdateSettingsInput {
  ...
  genesisBlocksGlobalSettingsSettingsGenesisBlocksMailchimpApiKey?: Maybe<
    Scalars["String"]
  >;
  genesisBlocksGlobalSettingsSettingsGenesisPageBuilderAnalyticsOptIn?: Maybe<
    Scalars["String"]
  >;
...
export const generatedSchema = {
  AssemblyVideo: {
    ...
    assemblyTime: { __type: "String" },
    assemblyVideoId: { __type: "Int!" },
    ...
    preview: { __type: "AssemblyVideoToPreviewConnectionEdge" },
    ...
    title: { __type: "String" },
    uri: { __type: "String" },
    video: { __type: "MediaItem" },
  },
  AssemblyVideoToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "AssemblyVideo" },
  },
  Avatar: {
    __typename: { __type: "String!" },
  ...
  Category: {
    ...
    link: { __type: "String" },
    mediaItems: {
      __type: "CategoryToMediaItemConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "CategoryToMediaItemConnectionWhereArgs",
      },
    },
    name: { __type: "String" },
  ...
  CategoryToMediaItemConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[CategoryToMediaItemConnectionEdge]" },
    nodes: { __type: "[MediaItem]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  CategoryToMediaItemConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "MediaItem" },
  },
  CategoryToMediaItemConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
  ...
  CreateAssemblyVideoPayload: {
    __typename: { __type: "String!" },
    assemblyVideo: { __type: "AssemblyVideo" },
    clientMutationId: { __type: "String" },
  },
  CreateCategoryInput: {
  ...
  CreateStaffMemberPayload: {
    __typename: { __type: "String!" },
    clientMutationId: { __type: "String" },
    staffMember: { __type: "StaffMember" },
  },
  CreateTagInput: {
    aliasOf: { __type: "String" },
    clientMutationId: { __type: "String" },
  ...
  DeleteAssemblyVideoInput: {
    clientMutationId: { __type: "String" },
    forceDelete: { __type: "Boolean" },
    id: { __type: "ID!" },
  },
  DeleteAssemblyVideoPayload: {
    __typename: { __type: "String!" },
    assemblyVideo: { __type: "AssemblyVideo" },
    clientMutationId: { __type: "String" },
    deletedId: { __type: "ID" },
  ...
  Employee: {
    __typename: { __type: "String!" },
    ancestors: {
      __type: "EmployeeToAncestorsEmployeeConnection",
      __args: { first: "Int", last: "Int", after: "String", before: "String" },
    },
    children: {
      __type: "EmployeeToEmployeeConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "EmployeeToEmployeeConnectionWhereArgs",
      },
    },
    conditionalTags: { __type: "ConditionalTags" },
    count: { __type: "Int" },
    ...
    link: { __type: "String" },
    name: { __type: "String" },
    parent: { __type: "EmployeeToParentEmployeeConnectionEdge" },
    parentDatabaseId: { __type: "Int" },
    parentId: { __type: "ID" },
    slug: { __type: "String" },
    taxonomy: { __type: "EmployeeToTaxonomyConnectionEdge" },
    templates: { __type: "[String]" },
    termGroupId: { __type: "Int" },
    termTaxonomyId: { __type: "Int" },
    uri: { __type: "String" },
  },
  EmployeeToAncestorsEmployeeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[EmployeeToAncestorsEmployeeConnectionEdge]" },
    nodes: { __type: "[Employee]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  EmployeeToAncestorsEmployeeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Employee" },
  },
  EmployeeToEmployeeConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[EmployeeToEmployeeConnectionEdge]" },
    nodes: { __type: "[Employee]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  EmployeeToEmployeeConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Employee" },
  },
  EmployeeToEmployeeConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  EmployeeToParentEmployeeConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Employee" },
  },
  EmployeeToTaxonomyConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "Taxonomy" },
  },
  EnqueuedAsset: {
  ...
  GenesisBlocksGlobalSettingsSettings: {
    ...
    genesisPageBuilderAnalyticsOptIn: { __type: "String" },
  ...
  MediaItem: {
    ...
    categories: {
      __type: "MediaItemToCategoryConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "MediaItemToCategoryConnectionWhereArgs",
      },
    },
    children: {
      __type: "HierarchicalContentNodeToContentNodeChildrenConnection",
  ...
  MediaItemToCategoryConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[MediaItemToCategoryConnectionEdge]" },
    nodes: { __type: "[Category]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  MediaItemToCategoryConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "Category" },
  },
  MediaItemToCategoryConnectionWhereArgs: {
    cacheDomain: { __type: "String" },
    childOf: { __type: "Int" },
    childless: { __type: "Boolean" },
    descriptionLike: { __type: "String" },
  ...
  RootQueryToAssemblyVideoConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToAssemblyVideoConnectionEdge]" },
    nodes: { __type: "[AssemblyVideo]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToAssemblyVideoConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "AssemblyVideo" },
  },
  RootQueryToAssemblyVideoConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  RootQueryToStaffMemberConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[RootQueryToStaffMemberConnectionEdge]" },
    nodes: { __type: "[StaffMember]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  RootQueryToStaffMemberConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "StaffMember" },
  },
  RootQueryToStaffMemberConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  Settings: {
    ...
    genesisBlocksGlobalSettingsSettingsGenesisPageBuilderAnalyticsOptIn: {
      __type: "String",
    },
  ...
  StaffMember: {
    ...
    modified: { __type: "String" },
    modifiedGmt: { __type: "String" },
    preview: { __type: "StaffMemberToPreviewConnectionEdge" },
    previewRevisionDatabaseId: { __type: "Int" },
    previewRevisionId: { __type: "ID" },
    profileImage: { __type: "MediaItem" },
    slug: { __type: "String" },
    staffMemberId: { __type: "Int!" },
    status: { __type: "String" },
    template: { __type: "ContentTemplate" },
    templates: { __type: "[String]" },
    uri: { __type: "String" },
  },
  StaffMemberToPreviewConnectionEdge: {
    __typename: { __type: "String!" },
    node: { __type: "StaffMember" },
  },
  Tag: {
  ...
  User: {
    __typename: { __type: "String!" },
    assemblyVideos: {
      __type: "UserToAssemblyVideoConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "UserToAssemblyVideoConnectionWhereArgs",
      },
    },
    avatar: {
      __type: "Avatar",
    ...
    slug: { __type: "String" },
    staffMembers: {
      __type: "UserToStaffMemberConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "UserToStaffMemberConnectionWhereArgs",
      },
    },
    templates: { __type: "[String]" },
    uri: { __type: "String" },
  ...
  UserToAssemblyVideoConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToAssemblyVideoConnectionEdge]" },
    nodes: { __type: "[AssemblyVideo]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToAssemblyVideoConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "AssemblyVideo" },
  },
  UserToAssemblyVideoConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  UserToStaffMemberConnection: {
    __typename: { __type: "String!" },
    edges: { __type: "[UserToStaffMemberConnectionEdge]" },
    nodes: { __type: "[StaffMember]" },
    pageInfo: { __type: "WPPageInfo" },
  },
  UserToStaffMemberConnectionEdge: {
    __typename: { __type: "String!" },
    cursor: { __type: "String" },
    node: { __type: "StaffMember" },
  },
  UserToStaffMemberConnectionWhereArgs: {
    author: { __type: "Int" },
    authorIn: { __type: "[ID]" },
    authorName: { __type: "String" },
    authorNotIn: { __type: "[ID]" },
  ...
  mutation: {
    __typename: { __type: "String!" },
    createAssemblyVideo: {
      __type: "CreateAssemblyVideoPayload",
      __args: { input: "CreateAssemblyVideoInput!" },
    },
    createCategory: {
    ...
    createStaffMember: {
      __type: "CreateStaffMemberPayload",
      __args: { input: "CreateStaffMemberInput!" },
    },
    createTag: {
    ...
    deleteAssemblyVideo: {
      __type: "DeleteAssemblyVideoPayload",
      __args: { input: "DeleteAssemblyVideoInput!" },
    },
    deleteCategory: {
    ...
    deleteStaffMember: {
      __type: "DeleteStaffMemberPayload",
      __args: { input: "DeleteStaffMemberInput!" },
    },
    deleteTag: {
    ...
    updateAssemblyVideo: {
      __type: "UpdateAssemblyVideoPayload",
      __args: { input: "UpdateAssemblyVideoInput!" },
    },
    updateCategory: {
    ...
    updateStaffMember: {
      __type: "UpdateStaffMemberPayload",
      __args: { input: "UpdateStaffMemberInput!" },
    },
    updateTag: {
  ...
  query: {
    ...
    allSettings: { __type: "Settings" },
    assemblyVideo: {
      __type: "AssemblyVideo",
      __args: {
        id: "ID!",
        idType: "AssemblyVideoIdType",
        asPreview: "Boolean",
      },
    },
    assemblyVideoBy: {
    ...
    assemblyVideos: {
      __type: "RootQueryToAssemblyVideoConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "RootQueryToAssemblyVideoConnectionWhereArgs",
      },
    },
    categories: {
    ...
    employee: {
      __type: "Employee",
      __args: { id: "ID!", idType: "EmployeeIdType" },
    },
    employees: {
    ...
    fAQ: {
      __type: "FAQ",
      __args: { id: "ID!", idType: "FAQIdType", asPreview: "Boolean" },
    },
    fAQBy: {
      __type: "FAQ",
      __args: { id: "ID", fAQId: "Int", uri: "String", slug: "String" },
    },
    fAQs: {
    ...
    staffMember: {
      __type: "StaffMember",
      __args: { id: "ID!", idType: "StaffMemberIdType", asPreview: "Boolean" },
    },
    staffMemberBy: {
      __type: "StaffMember",
      __args: { id: "ID", staffMemberId: "Int", uri: "String", slug: "String" },
    },
    staffMembers: {
      __type: "RootQueryToStaffMemberConnection",
      __args: {
        first: "Int",
        last: "Int",
        after: "String",
        before: "String",
        where: "RootQueryToStaffMemberConnectionWhereArgs",
      },
    },
  ...
  [SchemaUnionsKey]: {
    ...
    NodeWithTitle: ["MediaItem", "Post", "Page"],
    NodeWithComments: ["MediaItem", "Post", "Page"],
    HierarchicalContentNode: ["MediaItem", "Page"],
    TermNode: ["Category", "PostFormat", "Tag", "Employee"],
    HierarchicalTermNode: ["Category", "Employee"],
    MenuItemLinkable: ["Category", "Post", "Tag", "Page"],
    NodeWithContentEditor: ["Post", "Page"],
    NodeWithFeaturedImage: ["Post", "Page"],
    NodeWithExcerpt: ["Post"],
    NodeWithTrackbacks: ["Post"],
    NodeWithRevisions: ["Post", "Page"],
...
/**
 * The assemblyVideo type
 */
export interface AssemblyVideo {
  __typename?: "AssemblyVideo";
  assemblyTime?: Maybe<ScalarsEnums["String"]>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  assemblyVideoId: ScalarsEnums["Int"];
  /**
  ...
  /**
   * The globally unique identifier of the assemblyvideo object.
   */
  id: ScalarsEnums["ID"];
  /**
  ...
  /**
   * Connection between the assemblyVideo type and the assemblyVideo type
   */
  preview?: Maybe<AssemblyVideoToPreviewConnectionEdge>;
  /**
 ...
 * Connection between the assemblyVideo type and the assemblyVideo type
 */
export interface AssemblyVideoToPreviewConnectionEdge {
  __typename?: "AssemblyVideoToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<AssemblyVideo>;
}
...
export interface Category {
  ...
  mediaItems: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<CategoryToMediaItemConnectionWhereArgs>;
  }) => Maybe<CategoryToMediaItemConnection>;
  /**
 ...
 * Connection between the category type and the mediaItem type
 */
export interface CategoryToMediaItemConnection {
 ...
 * An edge in a connection
 */
export interface CategoryToMediaItemConnectionEdge {
...
/**
 * The payload for the createAssemblyVideo mutation
 */
export interface CreateAssemblyVideoPayload {
  __typename?: "CreateAssemblyVideoPayload";
  /**
   * The Post object mutation type.
   */
  assemblyVideo?: Maybe<AssemblyVideo>;
  /**
...
export interface CreateStaffMemberPayload {
  __typename?: "CreateStaffMemberPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
/**
 * The payload for the deleteAssemblyVideo mutation
 */
export interface DeleteAssemblyVideoPayload {
  __typename?: "DeleteAssemblyVideoPayload";
  /**
 ...
 */
export interface DeleteStaffMemberPayload {
  __typename?: "DeleteStaffMemberPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface Employee {
  ...
  ancestors: (args?: {
     ...
     */
    before?: Maybe<Scalars["String"]>;
  }) => Maybe<EmployeeToAncestorsEmployeeConnection>;
  /**
  ...
  children: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<EmployeeToEmployeeConnectionWhereArgs>;
  }) => Maybe<EmployeeToEmployeeConnection>;
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * The number of objects connected to the object
   */
   ...
   * @deprecated Deprecated in favor of databaseId
   */
  employeeId?: Maybe<ScalarsEnums["Int"]>;
  /**
   * Connection between the TermNode type and the EnqueuedScript type
   */
  enqueuedScripts: (args?: {
   ...
   * Connection between the employee type and the employee type
   */
  parent?: Maybe<EmployeeToParentEmployeeConnectionEdge>;
  /**
   * Database id of the parent node
   */
  parentDatabaseId?: Maybe<ScalarsEnums["Int"]>;
  ...
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the employee type and the Taxonomy type
   */
  taxonomy?: Maybe<EmployeeToTaxonomyConnectionEdge>;
  templates?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * The ID of the term group that this term object belongs to
   */
 ...
 * Connection between the employee type and the employee type
 */
export interface EmployeeToAncestorsEmployeeConnection {
  __typename?: "EmployeeToAncestorsEmployeeConnection";
  /**
   * Edges for the EmployeeToAncestorsEmployeeConnection connection
   */
  edges?: Maybe<Array<Maybe<EmployeeToAncestorsEmployeeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
 ...
 * An edge in a connection
 */
export interface EmployeeToAncestorsEmployeeConnectionEdge {
  __typename?: "EmployeeToAncestorsEmployeeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the employee type and the employee type
 */
export interface EmployeeToEmployeeConnection {
  __typename?: "EmployeeToEmployeeConnection";
  /**
   * Edges for the EmployeeToEmployeeConnection connection
   */
  edges?: Maybe<Array<Maybe<EmployeeToEmployeeConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<Employee>>>;
 ...
 * An edge in a connection
 */
export interface EmployeeToEmployeeConnectionEdge {
  __typename?: "EmployeeToEmployeeConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the employee type and the employee type
 */
export interface EmployeeToParentEmployeeConnectionEdge {
  __typename?: "EmployeeToParentEmployeeConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Employee>;
 ...
 * Connection between the employee type and the Taxonomy type
 */
export interface EmployeeToTaxonomyConnectionEdge {
  __typename?: "EmployeeToTaxonomyConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<Taxonomy>;
...
export interface GenesisBlocksGlobalSettingsSettings {
   ...
   * The string Settings Group
   */
  genesisPageBuilderAnalyticsOptIn?: Maybe<ScalarsEnums["String"]>;
  /**
   * The string Settings Group
   */
...
export interface MediaItem {
  ...
  categories: (args?: {
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<MediaItemToCategoryConnectionWhereArgs>;
  }) => Maybe<MediaItemToCategoryConnection>;
  /**
   * Connection between the HierarchicalContentNode type and the ContentNode type
   */
  children: (args?: {
 ...
 * Connection between the mediaItem type and the category type
 */
export interface MediaItemToCategoryConnection {
 ...
 * An edge in a connection
 */
export interface MediaItemToCategoryConnectionEdge {
...
export interface MenuItemLinkable {
  __typename?: "Category" | "Post" | "Tag" | "Page";
  /**
   * The unique resource identifier path
   */
  databaseId: ScalarsEnums["Int"];
...
export interface NodeWithComments {
  __typename?: "MediaItem" | "Post" | "Page";
  /**
   * The number of comments. Even though WPGraphQL denotes this field as an integer, in WordPress this field should be saved as a numeric string for compatibility.
   */
  commentCount?: Maybe<ScalarsEnums["Int"]>;
...
/**
 * Connection between the RootQuery type and the assemblyVideo type
 */
export interface RootQueryToAssemblyVideoConnection {
  __typename?: "RootQueryToAssemblyVideoConnection";
  /**
   * Edges for the RootQueryToAssemblyVideoConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToAssemblyVideoConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<AssemblyVideo>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToAssemblyVideoConnectionEdge {
  __typename?: "RootQueryToAssemblyVideoConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 */
export interface RootQueryToStaffMemberConnection {
  __typename?: "RootQueryToStaffMemberConnection";
  /**
   * Edges for the RootQueryToStaffMemberConnection connection
   */
  edges?: Maybe<Array<Maybe<RootQueryToStaffMemberConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<StaffMember>>>;
  /**
   * Information about pagination in a connection.
   */
  pageInfo?: Maybe<WPPageInfo>;
 ...
 * An edge in a connection
 */
export interface RootQueryToStaffMemberConnectionEdge {
  __typename?: "RootQueryToStaffMemberConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface StaffMember {
  ...
  guid?: Maybe<ScalarsEnums["String"]>;
  /**
   * The globally unique identifier of the staffmember object.
   */
  id: ScalarsEnums["ID"];
  /**
   * Whether the node is a Content Node
   ...
   * @deprecated Deprecated in favor of the databaseId field
   */
  staffMemberId: ScalarsEnums["Int"];
  /**
   * The current status of the object
   */
  status?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the staffMember type and the staffMember type
 */
export interface StaffMemberToPreviewConnectionEdge {
  __typename?: "StaffMemberToPreviewConnectionEdge";
  /**
   * The node of the connection, without the edges
   */
  node?: Maybe<StaffMember>;
...
export interface TermNode {
  __typename?: "Category" | "PostFormat" | "Tag" | "Employee";
  conditionalTags?: Maybe<ConditionalTags>;
  /**
   * The number of objects connected to the object
   */
...
/**
 * The payload for the updateAssemblyVideo mutation
 */
export interface UpdateAssemblyVideoPayload {
  __typename?: "UpdateAssemblyVideoPayload";
  /**
   * The Post object mutation type.
   */
  assemblyVideo?: Maybe<AssemblyVideo>;
...
export interface UpdateStaffMemberPayload {
  __typename?: "UpdateStaffMemberPayload";
  /**
   * If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions.
   */
  clientMutationId?: Maybe<ScalarsEnums["String"]>;
...
export interface User {
  __typename?: "User";
  /**
   * Connection between the User type and the assemblyVideo type
   */
  assemblyVideos: (args?: {
    /**
     * The number of items to return after the referenced "after" cursor
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToAssemblyVideoConnectionWhereArgs>;
  }) => Maybe<UserToAssemblyVideoConnection>;
  /**
  ...
  slug?: Maybe<ScalarsEnums["String"]>;
  /**
   * Connection between the User type and the staffMember type
   */
  staffMembers: (args?: {
    /**
     * The number of items to return after the referenced "after" cursor
     ...
     * Arguments for filtering the connection
     */
    where?: Maybe<UserToStaffMemberConnectionWhereArgs>;
  }) => Maybe<UserToStaffMemberConnection>;
  templates?: Maybe<Array<Maybe<ScalarsEnums["String"]>>>;
  /**
   * The unique resource identifier path
   */
 ...
 * Connection between the User type and the assemblyVideo type
 */
export interface UserToAssemblyVideoConnection {
  __typename?: "UserToAssemblyVideoConnection";
  /**
   * Edges for the UserToAssemblyVideoConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToAssemblyVideoConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<AssemblyVideo>>>;
 ...
 * An edge in a connection
 */
export interface UserToAssemblyVideoConnectionEdge {
  __typename?: "UserToAssemblyVideoConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
 ...
 * Connection between the User type and the staffMember type
 */
export interface UserToStaffMemberConnection {
  __typename?: "UserToStaffMemberConnection";
  /**
   * Edges for the UserToStaffMemberConnection connection
   */
  edges?: Maybe<Array<Maybe<UserToStaffMemberConnectionEdge>>>;
  /**
   * The nodes of the connection, without the edges
   */
  nodes?: Maybe<Array<Maybe<StaffMember>>>;
 ...
 * An edge in a connection
 */
export interface UserToStaffMemberConnectionEdge {
  __typename?: "UserToStaffMemberConnectionEdge";
  /**
   * A cursor for use in pagination
   */
  cursor?: Maybe<ScalarsEnums["String"]>;
...
export interface Mutation {
  __typename?: "Mutation";
  createAssemblyVideo: (args: {
    input: CreateAssemblyVideoInput;
  }) => Maybe<CreateAssemblyVideoPayload>;
  createCategory: (args: {
  ...
  createStaffMember: (args: {
    input: CreateStaffMemberInput;
  }) => Maybe<CreateStaffMemberPayload>;
  createTag: (args: { input: CreateTagInput }) => Maybe<CreateTagPayload>;
  createUser: (args: { input: CreateUserInput }) => Maybe<CreateUserPayload>;
  deleteAssemblyVideo: (args: {
    input: DeleteAssemblyVideoInput;
  }) => Maybe<DeleteAssemblyVideoPayload>;
  deleteCategory: (args: {
  ...
  deleteStaffMember: (args: {
    input: DeleteStaffMemberInput;
  }) => Maybe<DeleteStaffMemberPayload>;
  ...
  updateAssemblyVideo: (args: {
    input: UpdateAssemblyVideoInput;
  }) => Maybe<UpdateAssemblyVideoPayload>;
  updateCategory: (args: {
  ...
  }) => Maybe<UpdateStaffMemberPayload>;
...
export interface Query {
  ...
  assemblyVideo: (args: {
    id: Scalars["ID"];
    idType?: Maybe<AssemblyVideoIdType>;
    asPreview?: Maybe<Scalars["Boolean"]>;
  }) => Maybe<AssemblyVideo>;
  assemblyVideoBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    assemblyVideoId?: Maybe<Scalars["Int"]>;
  ...
  assemblyVideos: (args?: {
    ...
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    where?: Maybe<RootQueryToAssemblyVideoConnectionWhereArgs>;
  }) => Maybe<RootQueryToAssemblyVideoConnection>;
  categories: (args?: {
    first?: Maybe<Scalars["Int"]>;
    last?: Maybe<Scalars["Int"]>;
    after?: Maybe<Scalars["String"]>;
  ...
  staffMember: (args: {
    id: Scalars["ID"];
    idType?: Maybe<StaffMemberIdType>;
    asPreview?: Maybe<Scalars["Boolean"]>;
  }) => Maybe<StaffMember>;
  staffMemberBy: (args?: {
    id?: Maybe<Scalars["ID"]>;
    staffMemberId?: Maybe<Scalars["Int"]>;
    uri?: Maybe<Scalars["String"]>;
    slug?: Maybe<Scalars["String"]>;
  }) => Maybe<StaffMember>;
  staffMembers: (args?: {
    ...
    after?: Maybe<Scalars["String"]>;
    before?: Maybe<Scalars["String"]>;
    where?: Maybe<RootQueryToStaffMemberConnectionWhereArgs>;
  }) => Maybe<RootQueryToStaffMemberConnection>;
...
export interface SchemaObjectTypes {
  AssemblyVideo: AssemblyVideo;
  AssemblyVideoToPreviewConnectionEdge: AssemblyVideoToPreviewConnectionEdge;
  Avatar: Avatar;
  Category: Category;
  ...
  CategoryToMediaItemConnection: CategoryToMediaItemConnection;
  CategoryToMediaItemConnectionEdge: CategoryToMediaItemConnectionEdge;
  ...
  CreateAssemblyVideoPayload: CreateAssemblyVideoPayload;
  ...
  CreateStaffMemberPayload: CreateStaffMemberPayload;
  CreateTagPayload: CreateTagPayload;
  CreateUserPayload: CreateUserPayload;
  DefaultTemplate: DefaultTemplate;
  DeleteAssemblyVideoPayload: DeleteAssemblyVideoPayload;
  ...
  DeleteStaffMemberPayload: DeleteStaffMemberPayload;
  DeleteTagPayload: DeleteTagPayload;
  DeleteUserPayload: DeleteUserPayload;
  DiscussionSettings: DiscussionSettings;
  Employee: Employee;
  EmployeeToAncestorsEmployeeConnection: EmployeeToAncestorsEmployeeConnection;
  EmployeeToAncestorsEmployeeConnectionEdge: EmployeeToAncestorsEmployeeConnectionEdge;
  EmployeeToEmployeeConnection: EmployeeToEmployeeConnection;
  EmployeeToEmployeeConnectionEdge: EmployeeToEmployeeConnectionEdge;
  EmployeeToParentEmployeeConnectionEdge: EmployeeToParentEmployeeConnectionEdge;
  EmployeeToTaxonomyConnectionEdge: EmployeeToTaxonomyConnectionEdge;
  ...
  MediaItemToCategoryConnection: MediaItemToCategoryConnection;
  MediaItemToCategoryConnectionEdge: MediaItemToCategoryConnectionEdge;
  ...
  RootQueryToAssemblyVideoConnection: RootQueryToAssemblyVideoConnection;
  RootQueryToAssemblyVideoConnectionEdge: RootQueryToAssemblyVideoConnectionEdge;
  ...
  RootQueryToStaffMemberConnection: RootQueryToStaffMemberConnection;
  RootQueryToStaffMemberConnectionEdge: RootQueryToStaffMemberConnectionEdge;
  ...
  Settings: Settings;
  StaffMember: StaffMember;
  StaffMemberToPreviewConnectionEdge: StaffMemberToPreviewConnectionEdge;
  ...
  Theme: Theme;
  UpdateAssemblyVideoPayload: UpdateAssemblyVideoPayload;
  ...
  UpdateStaffMemberPayload: UpdateStaffMemberPayload;
  UpdateTagPayload: UpdateTagPayload;
  UpdateUserPayload: UpdateUserPayload;
  User: User;
  UserRole: UserRole;
  UserToAssemblyVideoConnection: UserToAssemblyVideoConnection;
  UserToAssemblyVideoConnectionEdge: UserToAssemblyVideoConnectionEdge;
  ...
  UserToStaffMemberConnection: UserToStaffMemberConnection;
  UserToStaffMemberConnectionEdge: UserToStaffMemberConnectionEdge;
...
export interface ScalarsEnums extends MakeNullable<Scalars> {
  AssemblyVideoIdType: AssemblyVideoIdType | undefined;
  ...
  StaffMemberIdType: StaffMemberIdType | undefined;
